...
class QQLogin {
    ...
    public function __construct(){
        $this->app_id      = "101374711";
        $this->app_key     = "213f81a5dadadcf6abc96be702f36a02";
        $this->callBackUrl = "http://www.pgsnote.com/Home/Login/qqlogin.html";
        //检查用户数据
    ...
    private function getUrl($url){
        ...
        $data = file_get_contents($url,false);//支持https:
        return $data;
